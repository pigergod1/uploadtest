...
<div class="site-wrap">
  ...
  <div class="site-blocks-cover" style="background-image: url(${contextRoot}/product/styles/front2/images/hero_1.jpg);" data-aos="fade">
    <div class="container">
        ...
        <div class="col-md-12">
          <div class="nonloop-block-3 owl-carousel">
            <div class="item">
              <div class="block-4 text-center">
                <figure class="block-4-image">
                  <img src="${contextRoot}/product/styles/front2/images/cloth_1.jpg" alt="Image placeholder" class="img-fluid">
                </figure>
            ...
            <div class="item">
              <div class="block-4 text-center">
                <figure class="block-4-image">
                  <img src="${contextRoot}/product/styles/front2/images/shoe_1.jpg" alt="Image placeholder" class="img-fluid">
                </figure>
                <div class="block-4-text p-4">
            ...
            <div class="item">
              <div class="block-4 text-center">
                <figure class="block-4-image">
                  <img src="${contextRoot}/product/styles/front2/images/cloth_2.jpg" alt="Image placeholder" class="img-fluid">
                </figure>
                <div class="block-4-text p-4">
            ...
            <div class="item">
              <div class="block-4 text-center">
                <figure class="block-4-image">
                  <img src="${contextRoot}/product/styles/front2/images/cloth_3.jpg" alt="Image placeholder" class="img-fluid">
                </figure>
                <div class="block-4-text p-4">
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col-md-12 col-lg-7 mb-5">
          <a href="#"><img src="${contextRoot}/product/styles/front2/images/blog_1.jpg" alt="Image placeholder" class="img-fluid rounded"></a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
          ...
          <a href="#" class="block-6">
            <img src="${contextRoot}/product/styles/front2/images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded mb-4">
